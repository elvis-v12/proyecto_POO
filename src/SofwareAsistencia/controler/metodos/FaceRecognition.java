...
public class FaceRecognition {
    ...
    public void startCapture() {
        if (!isRunning) {
            isRunning = true;
            capture.open(0); // Vuelve a abrir la cámara si estaba cerrada
                ...
                public void run() {
                    while (isRunning) {
                        if (capture.read(frameMat)) {
                            // Resto del código de detección facial y visualización
                            ...
                            for (Rect rect : faceDetections.toArray()) {
                                ...
                                String filename = "cara_" + System.currentTimeMillis() + ".jpg";
                                Imgcodecs.imwrite(filename, faceROI);
                                System.out.println("Cara capturada y guardada en: " + filename);
                            }

...
jfrmMatriculaAlumno Alumno;
    ...
    private void initComponents() {
        ...
        jtblAlumnos.setBackground(new java.awt.Color(51, 51, 255));
        jtblAlumnos.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(208, 208, 208)));
        jtblAlumnos.setFont(new java.awt.Font("Cascadia Mono", 0, 12)); // NOI18N
        ...
        jScrollPane18.setViewportView(jtblAlumnos);
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 140, 50));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1100, 1070));
...
int DNI;
        ...
        dtm.addRow(new Object[]{
          ID,DNI,nombre,ApellidoPaterno,ApellidoMaterno,Edad,Grado
        });

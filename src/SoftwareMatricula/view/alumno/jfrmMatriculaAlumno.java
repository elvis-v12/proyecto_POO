...
String nombre;
    ...
    private void initComponents() {
        ...
        jtxtGrado1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtxtGrado1ActionPerformed(evt);
            }
        });

        jLabel4.setText("Telefono:");

        txtTelefono.setFont(new java.awt.Font("Cascadia Mono", 0, 12)); // NOI18N
        txtTelefono.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(208, 208, 208)));
...
{
    datos = nombre + apellidoMaterno + apellidoPaterno + edad + Grado 
            +DNI + Telefono;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String apellido_paterno=jtxtApellidoPaterno1.getText();
       String apellido_materno=jtxtApellidoMaterno1.getText();
       int edad=Integer.parseInt(jtxtEdad1.getText());
       String grado=jtxtGrado1.getText();
       int telefono=Integer.parseInt(txtTelefono.getText());
        
        Alumno Alumno=new Alumno( dni, nombre, apellido_paterno, apellido_materno, edad, grado,telefono);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jtxtGrado1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtxtGrado1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtxtGrado1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
          jtxtDNI1.setText("");
       jtxtNombre1.setText("");
       jtxtApellidoPaterno1.setText("");
       jtxtApellidoMaterno1.setText("");
       jtxtEdad1.setText("");
       jtxtGrado1.setText("");
       txtTelefono.setText(""); 

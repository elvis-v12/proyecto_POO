...
import SoftwareMatricula.model.Administrador;
import SoftwareMatricula.view.alumno.jfrmListadoMatricula;
import SofwareMatricula.login.AdminstradorLogin;
 ...
 * 
 */
public class jfrmRegistroAdministrador extends javax.swing.JFrame {

        private static final long serialVersionUID = 1L;

        public jfrmRegistroAdministrador() {
                initComponents();
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        AdminstradorLogin admi=new AdminstradorLogin(Correo, password);
        
        if(txtUsuario.getText().equals("josemanuelsifuentes@gmail.com") && txtContraseña.getText().equals("admin1993V") ){
              JOptionPane.showMessageDialog(null, "Acceso correcto"+"\n","Vienvenidon al sistema adminitrador",JOptionPane.INFORMATION_MESSAGE);
            jfrmListadoMatricula aministrador=new jfrmListadoMatricula();
            aministrador.setVisible(true);
              dispose();
            
        }else{
            JOptionPane.showMessageDialog(null, "Acceso denegado"+"\n","Verifique que la contraseña y el correo sean correctos",JOptionPane.ERROR_MESSAGE);
        }
//        jfrmListadoMatricula lista = new jfrmListadoMatricula();
